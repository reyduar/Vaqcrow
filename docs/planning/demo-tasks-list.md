...
- **GitHub y estado:** [issue #240](https://github.com/reyduar/Vaqcrow/issues/240) · Tipo `Feature` · Área `docs` · Prioridad `High` · Workflow `Done`.
...
**Rama e implementación.** `Vaqcrow#240_Feat_Reconcile_trust_disclosures_with_contract_custody`, entregada mediante sus Tasks [#258](#^issue-258), [#259](#^issue-259) y [#260](#^issue-260), mergeada vía [PR #294](https://github.com/reyduar/Vaqcrow/pull/294). Flujo ODD (exploración delegada → implementación → pruebas → evidencia) con TDD estricto (RED observado antes de GREEN) y revisión RDD aprobada. Evidencia completa en [`trust-disclosures-and-contract-custody-evidence.md`](./trust-disclosures-and-contract-custody-evidence.md).
...
- **GitHub y estado:** [issue #258](https://github.com/reyduar/Vaqcrow/issues/258) · Tipo `Task` · Área `docs` · Prioridad `High` · Workflow `Done`.
...
**Rama e implementación.** Entregada como work unit sobre la rama de integración `Vaqcrow#240_Feat_Reconcile_trust_disclosures_with_contract_custody`, mergeada vía [PR #294](https://github.com/reyduar/Vaqcrow/pull/294). Agregó el sexto aviso canónico `contract-custody` (los aportes los custodia el contrato, el destino es fijo e inmutable, no hay recuperación ni clawback, y el reembolso por vencimiento es permissionless pero no auto-disparado) y reconcilió el checklist pre-firma del paso de fondeo de pago directo a invocación de bóveda; registró el texto en las cuatro superficies canónicas a la vez (`disclosures.ts`, `DEMO.md` §12, `demo-ui.md` §2 y §11).
...
- **GitHub y estado:** [issue #259](https://github.com/reyduar/Vaqcrow/issues/259) · Tipo `Task` · Área `frontend` · Prioridad `High` · Workflow `Done`.
...
**Rama e implementación.** Entregada como work unit sobre la rama de integración `Vaqcrow#240_Feat_Reconcile_trust_disclosures_with_contract_custody`, mergeada vía [PR #294](https://github.com/reyduar/Vaqcrow/pull/294). Sumó la guarda semántica independiente (13 afirmaciones que el contrato sostiene, más el denylist de sobrealcances) y las aserciones de render de la custodia y sus límites, donde la persona decide la custodia y donde se evidencia el reembolso; la sensibilidad de la guarda se probó por mutación.
...
- **GitHub y estado:** [issue #260](https://github.com/reyduar/Vaqcrow/issues/260) · Tipo `Task` · Área `docs` · Prioridad `High` · Workflow `Done`.
