...
- **GitHub y estado:** [issue #24](https://github.com/reyduar/Vaqcrow/issues/24) · Tipo `Feature` · Área `backend` · Prioridad `Critical` · Workflow `Ready`, promovida en el Project #4 al quedar [#23](#^issue-23) en `Done`.
