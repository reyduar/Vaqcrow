...
export class HttpClientError extends Error {
  ...
  constructor(kind: "http" | "network", status?: number, fieldErrors?: HttpFieldErrors) {
  ...
  toJSON(): {
    ...
    return { name: this.name, kind: this.kind, status: this.status, fieldErrors: this.fieldErrors };
  }
}
