...
- [ ] **T3 — Recorrido Playwright gateado.** Emulación de Freighter, rutas de campaña en el doble de la API (determinístico: sin `Date.now`/`Math.random`), spec del camino crítico y errores. Ruta: writer delegado.
